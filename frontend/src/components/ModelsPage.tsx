              ...
              {filtered.map((m) => (
                <tr key={m.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors">
                  ...
                  <td className="px-4 py-2 text-sm font-mono text-right text-gray-600 dark:text-gray-400">
                    {m.input_cost === 0 ? <span className="text-emerald-600 dark:text-emerald-400">Free</span> : `$${m.input_cost}`}
                  </td>
                  <td className="px-4 py-2 text-sm font-mono text-right text-gray-600 dark:text-gray-400">
                    {m.output_cost === 0 ? <span className="text-emerald-600 dark:text-emerald-400">Free</span> : `$${m.output_cost}`}
                  </td>
                </tr>
              ))}
              {filtered.length === 0 && (
